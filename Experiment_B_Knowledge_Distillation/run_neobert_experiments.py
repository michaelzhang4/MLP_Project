...
def predict_with_neobert(
    ...
    """Predict with a saved NeoBERT model. Returns (labels, confidences, logits, elapsed_s)."""
...
def run_kd_experiment(
    ...
    teacher_preds, teacher_confs, teacher_logits_raw, teacher_time_s = predict_with_neobert(
    ...
    train_teacher_preds, _, train_teacher_logits, _ = predict_with_neobert(
        teacher_path, train_texts, batch_size=batch_size
    )
    val_teacher_preds, _, val_teacher_logits, _ = predict_with_neobert(
