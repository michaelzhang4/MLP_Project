...
def plot_router_feature_importance(results: dict, out_dir: Path):
    """Feature importance of the router."""
    ...
    ax.set_title("V4: Router Feature Importance", fontsize=13)
...
def main():
    if len(sys.argv) > 1:
        ...
        json_path = str(Path(__file__).resolve().parent / "earlier_iterations" / "v4_quantized_early_exit" / "all_results_v4_quantized_early_exit_router.json")
